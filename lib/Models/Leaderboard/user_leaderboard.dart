...
//
//     final userLeaderboardModel = userLeaderboardModelFromJson(jsonString);

import 'dart:convert';

UserLeaderboardModel userLeaderboardModelFromJson(String str) =>
    UserLeaderboardModel.fromJson(json.decode(str));

String userLeaderboardModelToJson(UserLeaderboardModel data) =>
